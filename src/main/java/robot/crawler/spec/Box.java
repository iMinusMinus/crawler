 ...
 * @param noPushToContext 是否将WebElement在循环时作为上下文元素
 * @param hook 步骤执行的流程控制
 * @param steps 子步骤
 ...
 */
public record Box(String id, String name, String type, String target, boolean noPushToContext, StepHook hook, List<Step> steps,
